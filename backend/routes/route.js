...
const {registerUser, login, verifyEmail, resendEmailVerification, getPeople, updateProfile, getIdUser, getFollowers, follow, getFollowing} = require('../controller/authentication') // if {} as export, please import as {}
